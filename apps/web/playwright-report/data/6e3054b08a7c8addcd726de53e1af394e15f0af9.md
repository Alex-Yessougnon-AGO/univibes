...
- Name: language-persistence.spec.ts >> Language persistence >> locale persists via cookie when navigating between pages
- Location: tests/language-persistence.spec.ts:33:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/fr/explore
Call log:
  - navigating to "http://localhost:3000/fr/explore", waiting until "domcontentloaded"
