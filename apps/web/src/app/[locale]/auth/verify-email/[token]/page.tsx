    ...
    <div className="min-h-dvh flex items-center justify-center bg-[var(--bg)] px-5">
      {status === "loading" && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
          ...
          <p className="text-sm text-[var(--text-secondary)]">Vérification de ton email...</p>
        </motion.div>
      )}
      {status === "success" && (
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center max-w-sm">
          ...
          <h1 className="text-2xl font-[family-name:var(--font-display)] text-[var(--text)] tracking-tight mb-2">Email vérifié !</h1>
          ...
          <Button variant="primary" asChild>
            <Link href="/home">Accéder à mon espace <ArrowRight className="w-4 h-4" /></Link>
          </Button>
        </motion.div>
      )}
      {status === "error" && (
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center max-w-sm">
          ...
          <h1 className="text-2xl font-[family-name:var(--font-display)] text-[var(--text)] tracking-tight mb-2">Lien invalide ou expiré</h1>
